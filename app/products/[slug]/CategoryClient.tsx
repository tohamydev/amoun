    ...
    <div className="py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-4">{categoryName[getCurrentLanguage()]}</h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">{t('products.categoryDescription', { category: categoryName[getCurrentLanguage()] })}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product) => (
              ...
              >
                ...
                <div className="p-4">
                  <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-2">{product.name[getCurrentLanguage()]}</h2>
